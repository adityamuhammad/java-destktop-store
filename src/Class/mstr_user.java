...
public class mstr_user {
    ...
    public String user_id, nama, jenis_kelamin, tempat_lahir,
            tanggal_lahir, alamat, password;
    ...
    public void simpanData(){
        ...
        try {
            ...
            System.out.println("_simpan data error" + err);
        }
    }
    ...
    public void Cari(String _user_id) {
        ...
        try {
            _Akses = "";
            _Cnn = DBO.getConnection();
            String SQL = " SELECT * FROM mstr_user WHERE user_id = '" + pilih_user_id + "'";
    ...
    public void updateData() {
        ...
        try {
            ...
            _sql = "UPDATE store_akhtar.mstr_user SET" 
                    ...
                    + " password = '" + String.valueOf(password) + "' WHERE mstr_user.user_id = '" +String.valueOf(user_id) + "'";
